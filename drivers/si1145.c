...
si1145_init (sl_i2cspm_t *i2cspm)
{
  ...
  ret += si1145_set_parameter (
      ...
      SI1145_PARAM_CHLIST_EN_UV | SI1145_PARAM_CHLIST_EN_AUX
          | SI1145_PARAM_CHLIST_EN_EN_ALS_IR | SI1145_PARAM_CHLIST_EN_EN_ALS_VIS
  ...
  ret += si1145_set_parameter (
      i2cspm, SI1145_PARAM_ALS_IR_ADC_COUNTER,
      0x20 /* High Signal Range (Gain divided by 14.5)*/);
 ...
 ******************************************************************************/
sl_status_t
si1145_send_command (sl_i2cspm_t *i2cspm, uint8_t command)
{
  uint8_t response;
